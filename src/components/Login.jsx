        ...
        <div className="auth-left">
          <div className="auth-form-container">
            ...
            <p className="auth-subtitle">
              {isLogin ? (
                <>¿No tienes una cuenta? <button className="auth-link" onClick={toggleMode}>Crea una aquí</button></>
              ) : (
                <>¿Ya eres miembro? <button className="auth-link" onClick={toggleMode}>Inicia sesión aquí</button></>
              )}
            </p>
            ...
            <div className="auth-divider">
              <span>O {isLogin ? 'Inicia Sesión' : 'Regístrate'} Con Email</span>
            </div>
            ...
            {message && (
              <div className={`auth-message ${message.includes('exitoso') || message.includes('creada') ? 'success' : 'error'}`}>
                {message}
              </div>
            )}
          </div>
